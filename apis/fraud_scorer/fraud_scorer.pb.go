...
const file_fraud_scorer_proto_rawDesc = "" +
	...
	"\vFraudScorer\x12P\n" +
	"\x05Score\x12\".warp.fraud_scorer.v1.ScoreRequest\x1a#.warp.fraud_scorer.v1.ScoreResponseBU\n" +
	"\x18dev.warp.fraud_scorer.v1P\x01Z7github.com/warpdotdev/warp-proto-apis/apis/fraud_scorerb\x06proto3"
