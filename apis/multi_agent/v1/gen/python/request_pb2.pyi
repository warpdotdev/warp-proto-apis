...
class Request(_message.Message):
    ...
    class Settings(_message.Message):
        ...
        class ApiKeys(_message.Message):
            ...
            def __init__(self, anthropic: _Optional[str] = ..., openai: _Optional[str] = ..., google: _Optional[str] = ..., open_router: _Optional[str] = ..., allow_use_of_warp_credits: bool = ..., aws_credentials: _Optional[_Union[Request.Settings.ApiKeys.AWSCredentials, _Mapping]] = ...) -> None: ...
        ...
        def __init__(self, model_config: _Optional[_Union[Request.Settings.ModelConfig, _Mapping]] = ..., rules_enabled: bool = ..., web_context_retrieval_enabled: bool = ..., supports_parallel_tool_calls: bool = ..., use_anthropic_text_editor_tools: bool = ..., planning_enabled: bool = ..., warp_drive_context_enabled: bool = ..., supports_create_files: bool = ..., supported_tools: _Optional[_Iterable[_Union[_task_pb2.ToolType, str]]] = ..., supports_long_running_commands: bool = ..., should_preserve_file_content_in_history: bool = ..., supports_todos_ui: bool = ..., supports_linked_code_blocks: bool = ..., supports_started_child_task_message: bool = ..., supports_suggest_prompt: bool = ..., supports_read_image_files: bool = ..., supports_reasoning_message: bool = ..., api_keys: _Optional[_Union[Request.Settings.ApiKeys, _Mapping]] = ..., autonomy_level: _Optional[_Union[AutonomyLevel, str]] = ..., isolation_level: _Optional[_Union[IsolationLevel, str]] = ..., web_search_enabled: bool = ..., supported_cli_agent_tools: _Optional[_Iterable[_Union[_task_pb2.ToolType, str]]] = ..., supports_v4a_file_diffs: bool = ..., supports_summarization_via_message_replacement: bool = ..., supports_bundled_skills: bool = ...) -> None: ...
