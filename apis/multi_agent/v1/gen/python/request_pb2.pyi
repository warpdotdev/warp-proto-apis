...
class Request(_message.Message):
    ...
    class Input(_message.Message):
        ...
        class UserInputs(_message.Message):
            ...
            class UserInput(_message.Message):
                __slots__ = ("user_query", "tool_call_result", "cli_agent_user_query")
                USER_QUERY_FIELD_NUMBER: _ClassVar[int]
                ...
                def __init__(self, user_query: _Optional[_Union[Request.Input.UserQuery, _Mapping]] = ..., tool_call_result: _Optional[_Union[Request.Input.ToolCallResult, _Mapping]] = ..., cli_agent_user_query: _Optional[_Union[Request.Input.CLIAgentUserQuery, _Mapping]] = ...) -> None: ...
        ...
        class StartFromAmbientRunPrompt(_message.Message):
            __slots__ = ("ambient_run_id", "runtime_base_prompt", "runtime_skill")
            ...
            def __init__(self, ambient_run_id: _Optional[str] = ..., runtime_base_prompt: _Optional[str] = ..., runtime_skill: _Optional[_Union[_skill_pb2.Skill, _Mapping]] = ...) -> None: ...
    ...
    class Metadata(_message.Message):
        __slots__ = ("conversation_id", "logging", "ambient_agent_task_id", "forked_from_conversation_id")
        ...
        def __init__(self, conversation_id: _Optional[str] = ..., logging: _Optional[_Mapping[str, _struct_pb2.Value]] = ..., ambient_agent_task_id: _Optional[str] = ..., forked_from_conversation_id: _Optional[str] = ...) -> None: ...
