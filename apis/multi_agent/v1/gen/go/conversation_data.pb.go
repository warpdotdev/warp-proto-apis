...
func (x *ConversationData) Reset() {
	*x = ConversationData{}
	mi := &file_multi_agent_v1_conversation_data_proto_msgTypes[0]
...
// Deprecated: Marked as deprecated in multi_agent/v1/conversation_data.proto.
...
var File_multi_agent_v1_conversation_data_proto protoreflect.FileDescriptor

const file_multi_agent_v1_conversation_data_proto_rawDesc = "" +
	"\n" +
...
var file_multi_agent_v1_conversation_data_proto_depIdxs = []int32{
...
func init() { file_multi_agent_v1_conversation_data_proto_init() }
func file_multi_agent_v1_conversation_data_proto_init() {
	if File_multi_agent_v1_conversation_data_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_multi_agent_v1_conversation_data_proto_rawDesc), len(file_multi_agent_v1_conversation_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_multi_agent_v1_conversation_data_proto_goTypes,
		DependencyIndexes: file_multi_agent_v1_conversation_data_proto_depIdxs,
		MessageInfos:      file_multi_agent_v1_conversation_data_proto_msgTypes,
	}.Build()
	File_multi_agent_v1_conversation_data_proto = out.File
	file_multi_agent_v1_conversation_data_proto_goTypes = nil
	file_multi_agent_v1_conversation_data_proto_depIdxs = nil
}
