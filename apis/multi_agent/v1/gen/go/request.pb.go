...
func (x *Request_Input) GetStartFromAmbientTaskPrompt() *Request_Input_StartFromAmbientTaskPrompt {
	if x != nil {
		if x, ok := x.xxx_hidden_Type.(*request_Input_StartFromAmbientTaskPrompt_); ok {
			return x.StartFromAmbientTaskPrompt
		}
	}
	return nil
}
...
func (x *Request_Input) SetStartFromAmbientTaskPrompt(v *Request_Input_StartFromAmbientTaskPrompt) {
	if v == nil {
		x.xxx_hidden_Type = nil
		return
	}
	x.xxx_hidden_Type = &request_Input_StartFromAmbientTaskPrompt_{v}
}
...
func (x *Request_Input) HasStartFromAmbientTaskPrompt() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Type.(*request_Input_StartFromAmbientTaskPrompt_)
	return ok
}
...
func (x *Request_Input) ClearStartFromAmbientTaskPrompt() {
	if _, ok := x.xxx_hidden_Type.(*request_Input_StartFromAmbientTaskPrompt_); ok {
		x.xxx_hidden_Type = nil
	}
}
...
const Request_Input_StartFromAmbientTaskPrompt_case case_Request_Input_Type = 16
...
func (x *Request_Input) WhichType() case_Request_Input_Type {
	...
	case *request_Input_StartFromAmbientTaskPrompt_:
		return Request_Input_StartFromAmbientTaskPrompt_case
...
type Request_Input_builder struct {
	...
	StartFromAmbientTaskPrompt *Request_Input_StartFromAmbientTaskPrompt
	// Deprecated: Marked as deprecated in request.proto.
...
func (b0 Request_Input_builder) Build() *Request_Input {
	...
	if b.StartFromAmbientTaskPrompt != nil {
		x.xxx_hidden_Type = &request_Input_StartFromAmbientTaskPrompt_{b.StartFromAmbientTaskPrompt}
	}
	if b.UserQuery != nil {
...
type request_Input_StartFromAmbientTaskPrompt_ struct {
	StartFromAmbientTaskPrompt *Request_Input_StartFromAmbientTaskPrompt `protobuf:"bytes,16,opt,name=start_from_ambient_task_prompt,json=startFromAmbientTaskPrompt,oneof"`
}
...
func (*request_Input_StartFromAmbientTaskPrompt_) isRequest_Input_Type() {}
...
type Request_Input_StartFromAmbientTaskPrompt struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_AmbientTaskId *string                `protobuf:"bytes,1,opt,name=ambient_task_id,json=ambientTaskId"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *Request_Input_StartFromAmbientTaskPrompt) Reset() {
	*x = Request_Input_StartFromAmbientTaskPrompt{}
	mi := &file_request_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Request_Input_StartFromAmbientTaskPrompt) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Request_Input_StartFromAmbientTaskPrompt) ProtoMessage() {}

func (x *Request_Input_StartFromAmbientTaskPrompt) ProtoReflect() protoreflect.Message {
	mi := &file_request_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *Request_Input_StartFromAmbientTaskPrompt) GetAmbientTaskId() string {
	if x != nil {
		if x.xxx_hidden_AmbientTaskId != nil {
			return *x.xxx_hidden_AmbientTaskId
		}
		return ""
	}
	return ""
...
func (x *Request_Input_StartFromAmbientTaskPrompt) SetAmbientTaskId(v string) {
	x.xxx_hidden_AmbientTaskId = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *Request_Input_StartFromAmbientTaskPrompt) HasAmbientTaskId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *Request_Input_StartFromAmbientTaskPrompt) ClearAmbientTaskId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_AmbientTaskId = nil
}

type Request_Input_StartFromAmbientTaskPrompt_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// The ambient agent task ID to resolve the prompt from.
	AmbientTaskId *string
}

func (b0 Request_Input_StartFromAmbientTaskPrompt_builder) Build() *Request_Input_StartFromAmbientTaskPrompt {
	m0 := &Request_Input_StartFromAmbientTaskPrompt{}
	b, x := &b0, m0
	_, _ = b, x
	if b.AmbientTaskId != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 1)
		x.xxx_hidden_AmbientTaskId = b.AmbientTaskId
	}
	return m0
}
...
const file_request_proto_rawDesc = "" +
	...
	"mcpContext\x1aT\n" +
	"\vTaskContext\x12/\n" +
	"\x05tasks\x18\x01 \x03(\v2\x19.warp.multi_agent.v1.TaskR\x05tasksJ\x04\b\x02\x10\x03R\x0eactive_task_id\x1a\x814\n" +
	"\x05Input\x12;\n" +
	...
	"\x15fetch_review_comments\x18\x0f \x01(\v26.warp.multi_agent.v1.Request.Input.FetchReviewCommentsH\x00R\x13fetchReviewComments\x12\x83\x01\n" +
	"\x1estart_from_ambient_task_prompt\x18\x10 \x01(\v2=.warp.multi_agent.v1.Request.Input.StartFromAmbientTaskPromptH\x00R\x1astartFromAmbientTaskPrompt\x12Q\n" +
	"\n" +
	...
	"\x06prompt\x18\x01 \x01(\tB\x04\x80\xb5\x18\x01R\x06prompt\x1aD\n" +
	"\x1aStartFromAmbientTaskPrompt\x12&\n" +
	"\x0fambient_task_id\x18\x01 \x01(\tR\rambientTaskIdB\x06\n" +
	"\x04type\x1a\xc7\x02\n" +
	"\bMetadata\x12'\n" +
...
var file_request_proto_goTypes = []any{
	...
	(*Request_Input_StartFromAmbientTaskPrompt)(nil), // 23: warp.multi_agent.v1.Request.Input.StartFromAmbientTaskPrompt
...
var file_request_proto_depIdxs = []int32{
	...
	23, // 20: warp.multi_agent.v1.Request.Input.start_from_ambient_task_prompt:type_name -> warp.multi_agent.v1.Request.Input.StartFromAmbientTaskPrompt
...
func file_request_proto_init() {
	...
	file_request_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*request_Input_StartFromAmbientTaskPrompt_)(nil),
