...
type Request_Input_UserQuery struct {
	...
	xxx_hidden_AttributionToken      *string                `protobuf:"bytes,5,opt,name=attribution_token,json=attributionToken"`
	XXX_raceDetectHookData           protoimpl.RaceDetectHookData
	XXX_presence                     [1]uint32
	unknownFields                    protoimpl.UnknownFields
	sizeCache                        protoimpl.SizeCache
...
func (x *Request_Input_UserQuery) GetAttributionToken() string {
	if x != nil {
		if x.xxx_hidden_AttributionToken != nil {
			return *x.xxx_hidden_AttributionToken
		}
		return ""
	}
	return ""
...
func (x *Request_Input_UserQuery) SetAttributionToken(v string) {
	x.xxx_hidden_AttributionToken = &v
...
func (x *Request_Input_UserQuery) HasAttributionToken() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 4)
...
func (x *Request_Input_UserQuery) ClearAttributionToken() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 4)
	x.xxx_hidden_AttributionToken = nil
}
...
type Request_Input_UserQuery_builder struct {
	...
	// Opaque, server-issued attribution token for a query the server
	// injected into a running cloud agent (e.g. a Slack follow-up). The
	// server attaches it to the injected message and the client echoes it
	// back verbatim; the server decodes it into origin / author /
	// source_message on the persisted Message.UserQuery.
	//
	// Integrity: the token is authenticated with a server-held key
	// (encrypted or signed), so a client cannot forge or alter attribution.
	// A token that fails verification is discarded and the query is
	// persisted with origin = server_synthesized and
	// author.resolution = UNRESOLVED. Clients never construct or interpret
	// it and cannot set attribution directly.
...
func (b0 Request_Input_UserQuery_builder) Build() *Request_Input_UserQuery {
	...
	if b.AttributionToken != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 4, 5)
		x.xxx_hidden_AttributionToken = b.AttributionToken
	}
	return m0
}
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\x1a\x13orchestration.proto\"\xf4}\n" +
	"\aRequest\x12K\n" +
	...
	"mcpContext\x1aT\n" +
	"\vTaskContext\x12/\n" +
	"\x05tasks\x18\x01 \x03(\v2\x19.warp.multi_agent.v1.TaskR\x05tasksJ\x04\b\x02\x10\x03R\x0eactive_task_id\x1a\xb9L\n" +
	"\x05Input\x12;\n" +
	...
	"\x10tool_call_result\x18\x03 \x01(\v21.warp.multi_agent.v1.Request.Input.ToolCallResultB\x02\x18\x01H\x00R\x0etoolCallResult\x1a\xbe\x03\n" +
	"\tUserQuery\x12\x1a\n" +
	...
	"\x11attribution_token\x18\x05 \x01(\tR\x10attributionToken\x1ai\n" +
...
var file_request_proto_goTypes = []any{
	...
	(*UploadFileArtifactResult)(nil),                                         // 94: warp.multi_agent.v1.UploadFileArtifactResult
	(*RunAgentsResult)(nil),                                                  // 95: warp.multi_agent.v1.RunAgentsResult
	(*WaitForEventsResult)(nil),                                              // 96: warp.multi_agent.v1.WaitForEventsResult
	(*StartRecordingResult)(nil),                                             // 97: warp.multi_agent.v1.StartRecordingResult
	(*StopRecordingResult)(nil),                                              // 98: warp.multi_agent.v1.StopRecordingResult
...
var file_request_proto_depIdxs = []int32{
	...
	91,  // 67: warp.multi_agent.v1.Request.Input.ToolCallResult.send_message_to_agent:type_name -> warp.multi_agent.v1.SendMessageToAgentResult
	92,  // 68: warp.multi_agent.v1.Request.Input.ToolCallResult.transfer_shell_command_control_to_user:type_name -> warp.multi_agent.v1.TransferShellCommandControlToUserResult
	93,  // 69: warp.multi_agent.v1.Request.Input.ToolCallResult.ask_user_question:type_name -> warp.multi_agent.v1.AskUserQuestionResult
	94,  // 70: warp.multi_agent.v1.Request.Input.ToolCallResult.upload_file_artifact:type_name -> warp.multi_agent.v1.UploadFileArtifactResult
	95,  // 71: warp.multi_agent.v1.Request.Input.ToolCallResult.run_agents_result:type_name -> warp.multi_agent.v1.RunAgentsResult
	96,  // 72: warp.multi_agent.v1.Request.Input.ToolCallResult.wait_for_events:type_name -> warp.multi_agent.v1.WaitForEventsResult
	97,  // 73: warp.multi_agent.v1.Request.Input.ToolCallResult.start_recording:type_name -> warp.multi_agent.v1.StartRecordingResult
	98,  // 74: warp.multi_agent.v1.Request.Input.ToolCallResult.stop_recording:type_name -> warp.multi_agent.v1.StopRecordingResult
	...
	50,  // 109: warp.multi_agent.v1.Request.Settings.CustomModelProviders.providers:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelProviders.CustomModelProvider
	52,  // 110: warp.multi_agent.v1.Request.Settings.CustomModelRouters.routers:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelRouters.CustomModelRouter
	51,  // 111: warp.multi_agent.v1.Request.Settings.CustomModelProviders.CustomModelProvider.models:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelProviders.CustomModel
	2,   // 112: warp.multi_agent.v1.Request.Settings.CustomModelProviders.CustomModelProvider.schema:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelProviders.CustomEndpointSchema
	53,  // 113: warp.multi_agent.v1.Request.Settings.CustomModelRouters.CustomModelRouter.complexity:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelRouters.ComplexityBasedRouter
	54,  // 114: warp.multi_agent.v1.Request.Settings.CustomModelRouters.CustomModelRouter.prompt:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelRouters.PromptBasedRouter
	55,  // 115: warp.multi_agent.v1.Request.Settings.CustomModelRouters.PromptBasedRouter.rules:type_name -> warp.multi_agent.v1.Request.Settings.CustomModelRouters.PromptBasedRouter.PromptRule
