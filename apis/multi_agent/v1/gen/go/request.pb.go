...
type Request_Input_UserQuery_builder struct {
	...
	// names there). Unset for queries a human typed in a Warp client. Not
	// verified for now: a client can set these directly.
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\x1a\x13orchestration.proto\x1a\x11attribution.proto\"\x8c\x7f\n" +
	"\aRequest\x12K\n" +
