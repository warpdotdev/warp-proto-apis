...
const Request_Input_SummarizeConversation_case case_Request_Input_Type = 12
...
type request_Input_SummarizeConversation_ struct {
	SummarizeConversation *Request_Input_SummarizeConversation `protobuf:"bytes,12,opt,name=summarize_conversation,json=summarizeConversation,oneof"`
}
...
// An input to trigger summarization of the current conversation.
// This does not produce a follow-up message; the server responds with ClientAction.UpdateTaskSummary.
...
func (x *Request_Input_SummarizeConversation) GetTaskId() string {
	if x != nil {
...
func (x *Request_Input_SummarizeConversation) SetTaskId(v string) {
	x.xxx_hidden_TaskId = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *Request_Input_SummarizeConversation) HasTaskId() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *Request_Input_SummarizeConversation) ClearTaskId() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
...
type Request_Input_SummarizeConversation_builder struct {
	...
	// Optional: if unset, server uses the active task ID.
	TaskId *string
}
...
const file_request_proto_rawDesc = "" +
	...
	"\x0eactive_task_id\x18\x02 \x01(\tR\factiveTaskId\x1a\xd3$\n" +
	"\x05Input\x12;\n" +
	...
	"\x16summarize_conversation\x18\f \x01(\v28.warp.multi_agent.v1.Request.Input.SummarizeConversationH\x00R\x15summarizeConversation\x12Q\n" +
	"\n" +
	...
	"\x03url\x18\x01 \x01(\tB\x04\x80\xb5\x18\x01R\x03url\x1a0\n" +
	"\x15SummarizeConversation\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x1a\xde\x01\n" +
...
var file_request_proto_goTypes = []any{
	...
	(*Request_Input_SummarizeConversation)(nil),   // 15: warp.multi_agent.v1.Request.Input.SummarizeConversation
	...
	(*Attachment)(nil),                           // 50: warp.multi_agent.v1.Attachment
...
var file_request_proto_depIdxs = []int32{
	...
	15, // 16: warp.multi_agent.v1.Request.Input.summarize_conversation:type_name -> warp.multi_agent.v1.Request.Input.SummarizeConversation
	...
	33, // 21: warp.multi_agent.v1.Request.Settings.supported_tools:type_name -> warp.multi_agent.v1.ToolType
	...
	17, // 24: warp.multi_agent.v1.Request.Input.UserQuery.referenced_attachments:type_name -> warp.multi_agent.v1.Request.Input.UserQuery.ReferencedAttachmentsEntry
	18, // 25: warp.multi_agent.v1.Request.Input.UserInputs.inputs:type_name -> warp.multi_agent.v1.Request.Input.UserInputs.UserInput
	...
	19, // 34: warp.multi_agent.v1.Request.Input.ToolCallResult.refine:type_name -> warp.multi_agent.v1.Request.Input.ToolCallResult.RefineResult
	...
	50, // 49: warp.multi_agent.v1.Request.Input.TriggerSuggestPrompt.attachments:type_name -> warp.multi_agent.v1.Attachment
	51, // 50: warp.multi_agent.v1.Request.Input.TriggerSuggestPrompt.files_changed:type_name -> google.protobuf.Empty
	51, // 51: warp.multi_agent.v1.Request.Input.TriggerSuggestPrompt.command_run:type_name -> google.protobuf.Empty
	50, // 52: warp.multi_agent.v1.Request.Input.UserQuery.ReferencedAttachmentsEntry.value:type_name -> warp.multi_agent.v1.Attachment
	6,  // 53: warp.multi_agent.v1.Request.Input.UserInputs.UserInput.user_query:type_name -> warp.multi_agent.v1.Request.Input.UserQuery
	8,  // 54: warp.multi_agent.v1.Request.Input.UserInputs.UserInput.tool_call_result:type_name -> warp.multi_agent.v1.Request.Input.ToolCallResult
	6,  // 55: warp.multi_agent.v1.Request.Input.ToolCallResult.RefineResult.user_query:type_name -> warp.multi_agent.v1.Request.Input.UserQuery
	52, // 56: warp.multi_agent.v1.Request.Metadata.LoggingEntry.value:type_name -> google.protobuf.Value
	53, // 57: warp.multi_agent.v1.Request.MCPContext.MCPTool.input_schema:type_name -> google.protobuf.Struct
