...
type Request_Settings struct {
	...
	xxx_hidden_SupportsSkills                     bool                          `protobuf:"varint,24,opt,name=supports_skills,json=supportsSkills"`
	XXX_raceDetectHookData                        protoimpl.RaceDetectHookData
	XXX_presence                                  [1]uint32
	unknownFields                                 protoimpl.UnknownFields
	sizeCache                                     protoimpl.SizeCache
...
func (x *Request_Settings) GetSupportsSkills() bool {
	if x != nil {
		return x.xxx_hidden_SupportsSkills
	}
	return false
}
...
func (x *Request_Settings) SetSupportsSkills(v bool) {
	x.xxx_hidden_SupportsSkills = v
...
func (x *Request_Settings) HasSupportsSkills() bool {
	if x == nil {
		return false
	}
...
func (x *Request_Settings) ClearSupportsSkills() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 23)
	x.xxx_hidden_SupportsSkills = false
}
...
type Request_Settings_builder struct {
	...
	// If `true`, the client supports Skills
	SupportsSkills *bool
}
...
func (b0 Request_Settings_builder) Build() *Request_Settings {
	...
	if b.SupportsSkills != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 23, 24)
		x.xxx_hidden_SupportsSkills = *b.SupportsSkills
	}
	return m0
}
...
const file_request_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\xce\x10\n" +
	"\bSettings\x12T\n" +
	...
	"\x17supports_v4a_file_diffs\x18\x17 \x01(\bR\x14supportsV4aFileDiffs\x12'\n" +
	"\x0fsupports_skills\x18\x18 \x01(\bR\x0esupportsSkills\x1av\n" +
