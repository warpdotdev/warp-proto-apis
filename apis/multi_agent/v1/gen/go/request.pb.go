...
func (x *Request_Input_UserInputs_UserInput) GetCodeReview() *Request_Input_CodeReview {
	if x != nil {
		if x, ok := x.xxx_hidden_Input.(*request_Input_UserInputs_UserInput_CodeReview); ok {
			return x.CodeReview
		}
	}
	return nil
...
func (x *Request_Input_UserInputs_UserInput) SetCodeReview(v *Request_Input_CodeReview) {
	if v == nil {
		x.xxx_hidden_Input = nil
		return
	}
	x.xxx_hidden_Input = &request_Input_UserInputs_UserInput_CodeReview{v}
}
...
func (x *Request_Input_UserInputs_UserInput) HasCodeReview() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Input.(*request_Input_UserInputs_UserInput_CodeReview)
	return ok
}
...
func (x *Request_Input_UserInputs_UserInput) ClearCodeReview() {
	if _, ok := x.xxx_hidden_Input.(*request_Input_UserInputs_UserInput_CodeReview); ok {
		x.xxx_hidden_Input = nil
	}
}
...
const Request_Input_UserInputs_UserInput_CodeReview_case case_Request_Input_UserInputs_UserInput_Input = 4
...
func (x *Request_Input_UserInputs_UserInput) WhichInput() case_Request_Input_UserInputs_UserInput_Input {
	...
	case *request_Input_UserInputs_UserInput_CodeReview:
		return Request_Input_UserInputs_UserInput_CodeReview_case
	default:
		return Request_Input_UserInputs_UserInput_Input_not_set_case
	}
}
...
func (b0 Request_Input_UserInputs_UserInput_builder) Build() *Request_Input_UserInputs_UserInput {
	...
	if b.CodeReview != nil {
		x.xxx_hidden_Input = &request_Input_UserInputs_UserInput_CodeReview{b.CodeReview}
	}
	return m0
}
...
type request_Input_UserInputs_UserInput_CodeReview struct {
	CodeReview *Request_Input_CodeReview `protobuf:"bytes,4,opt,name=code_review,json=codeReview,oneof"`
}
...
func (*request_Input_UserInputs_UserInput_CodeReview) isRequest_Input_UserInputs_UserInput_Input() {}
...
const file_request_proto_rawDesc = "" +
	...
	"mcpContext\x1aT\n" +
	"\vTaskContext\x12/\n" +
	"\x05tasks\x18\x01 \x03(\v2\x19.warp.multi_agent.v1.TaskR\x05tasksJ\x04\b\x02\x10\x03R\x0eactive_task_id\x1a\xd14\n" +
	"\x05Input\x12;\n" +
	...
	"\x10tool_call_result\x18\x03 \x01(\v21.warp.multi_agent.v1.Request.Input.ToolCallResultB\x02\x18\x01H\x00R\x0etoolCallResult\x12T\n" +
	"\vcode_review\x18\f \x01(\v2-.warp.multi_agent.v1.Request.Input.CodeReviewB\x02\x18\x01H\x00R\n" +
	"codeReview\x1a\x91\x03\n" +
	"\tUserQuery\x12\x1a\n" +
	...
	"\x1erun_shell_command_tool_call_id\x18\x03 \x01(\tR\x19runShellCommandToolCallId\x1a\xdd\x03\n" +
	"\n" +
	"UserInputs\x12O\n" +
	"\x06inputs\x18\x01 \x03(\v27.warp.multi_agent.v1.Request.Input.UserInputs.UserInputR\x06inputs\x1a\xfd\x02\n" +
	"\tUserInput\x12M\n" +
	"\n" +
	...
	"\x14cli_agent_user_query\x18\x03 \x01(\v24.warp.multi_agent.v1.Request.Input.CLIAgentUserQueryH\x00R\x11cliAgentUserQuery\x12P\n" +
	"\vcode_review\x18\x04 \x01(\v2-.warp.multi_agent.v1.Request.Input.CodeReviewH\x00R\n" +
	"codeReviewB\a\n" +
...
var file_request_proto_depIdxs = []int32{
	...
	22, // 16: warp.multi_agent.v1.Request.Input.summarize_conversation:type_name -> warp.multi_agent.v1.Request.Input.SummarizeConversation
	18, // 17: warp.multi_agent.v1.Request.Input.create_environment:type_name -> warp.multi_agent.v1.Request.Input.CreateEnvironment
	21, // 18: warp.multi_agent.v1.Request.Input.fetch_review_comments:type_name -> warp.multi_agent.v1.Request.Input.FetchReviewComments
	23, // 19: warp.multi_agent.v1.Request.Input.start_from_ambient_run_prompt:type_name -> warp.multi_agent.v1.Request.Input.StartFromAmbientRunPrompt
	...
	20, // 22: warp.multi_agent.v1.Request.Input.code_review:type_name -> warp.multi_agent.v1.Request.Input.CodeReview
	...
	20, // 77: warp.multi_agent.v1.Request.Input.UserInputs.UserInput.code_review:type_name -> warp.multi_agent.v1.Request.Input.CodeReview
...
func file_request_proto_init() {
	...
	file_request_proto_msgTypes[23].OneofWrappers = []any{
		...
		(*request_Input_UserInputs_UserInput_CodeReview)(nil),
	}
	type x struct{}
