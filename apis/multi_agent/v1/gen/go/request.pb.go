...
type Request_Settings struct {
	...
	xxx_hidden_ResearchAgentEnabled                       bool                          `protobuf:"varint,26,opt,name=research_agent_enabled,json=researchAgentEnabled"`
	XXX_raceDetectHookData                                protoimpl.RaceDetectHookData
	XXX_presence                                          [1]uint32
	unknownFields                                         protoimpl.UnknownFields
	sizeCache                                             protoimpl.SizeCache
...
func (x *Request_Settings) GetResearchAgentEnabled() bool {
	if x != nil {
		return x.xxx_hidden_ResearchAgentEnabled
	}
	return false
}
...
func (x *Request_Settings) SetResearchAgentEnabled(v bool) {
	x.xxx_hidden_ResearchAgentEnabled = v
...
func (x *Request_Settings) HasResearchAgentEnabled() bool {
	if x == nil {
		return false
	}
...
func (x *Request_Settings) ClearResearchAgentEnabled() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 25)
	x.xxx_hidden_ResearchAgentEnabled = false
}
...
type Request_Settings_builder struct {
	...
	// If `true`, the research agent can be used to perform research tasks.
	// Populated from the 'ResearchAgentEnabled' user preference.
	ResearchAgentEnabled *bool
}
...
func (b0 Request_Settings_builder) Build() *Request_Settings {
	...
	if b.ResearchAgentEnabled != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 25, 26)
		x.xxx_hidden_ResearchAgentEnabled = *b.ResearchAgentEnabled
	}
	return m0
}
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\"\xd4b\n" +
	"\aRequest\x12K\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\xa6\x12\n" +
	"\bSettings\x12T\n" +
	...
	"\x17supports_bundled_skills\x18\x19 \x01(\bR\x15supportsBundledSkills\x124\n" +
	"\x16research_agent_enabled\x18\x1a \x01(\bR\x14researchAgentEnabled\x1a\xa4\x01\n" +
