...
type Request_Settings struct {
	...
	xxx_hidden_WebFetchEnabled                            bool                          `protobuf:"varint,26,opt,name=web_fetch_enabled,json=webFetchEnabled"`
...
type Request_Settings_builder struct {
	...
	// If `true`, the agent may fetch web pages when helpful for completing tasks.
	// Controlled by the user's execution profile settings.
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\"\xc7T\n" +
	"\aRequest\x12K\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\x9c\x12\n" +
	"\bSettings\x12T\n" +
	...
	"\x12web_search_enabled\x18\x15 \x01(\bR\x10webSearchEnabled\x12*\n" +
	"\x11web_fetch_enabled\x18\x1a \x01(\bR\x0fwebFetchEnabled\x12X\n" +
