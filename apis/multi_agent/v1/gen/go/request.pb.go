...
func (x *Request_Input_ToolCallResult) GetAskQuestion() *AskQuestionResult {
	if x != nil {
		if x, ok := x.xxx_hidden_Result.(*request_Input_ToolCallResult_AskQuestion); ok {
...
func (x *Request_Input_ToolCallResult) SetAskQuestion(v *AskQuestionResult) {
	if v == nil {
		x.xxx_hidden_Result = nil
		return
	}
	x.xxx_hidden_Result = &request_Input_ToolCallResult_AskQuestion{v}
}
...
func (x *Request_Input_ToolCallResult) HasAskQuestion() bool {
	if x == nil {
		return false
	}
	_, ok := x.xxx_hidden_Result.(*request_Input_ToolCallResult_AskQuestion)
	return ok
}
...
func (x *Request_Input_ToolCallResult) ClearAskQuestion() {
	if _, ok := x.xxx_hidden_Result.(*request_Input_ToolCallResult_AskQuestion); ok {
		x.xxx_hidden_Result = nil
	}
}
...
const Request_Input_ToolCallResult_AskQuestion_case case_Request_Input_ToolCallResult_Result = 27
...
func (x *Request_Input_ToolCallResult) WhichResult() case_Request_Input_ToolCallResult_Result {
	...
	case *request_Input_ToolCallResult_AskQuestion:
		return Request_Input_ToolCallResult_AskQuestion_case
	default:
		return Request_Input_ToolCallResult_Result_not_set_case
	}
}
...
func (b0 Request_Input_ToolCallResult_builder) Build() *Request_Input_ToolCallResult {
	...
	if b.AskQuestion != nil {
		x.xxx_hidden_Result = &request_Input_ToolCallResult_AskQuestion{b.AskQuestion}
	}
	return m0
}
...
type request_Input_ToolCallResult_AskQuestion struct {
	AskQuestion *AskQuestionResult `protobuf:"bytes,27,opt,name=ask_question,json=askQuestion,oneof"`
}
...
func (*request_Input_ToolCallResult_AskQuestion) isRequest_Input_ToolCallResult_Result() {}
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\"\xaaU\n" +
	"\aRequest\x12K\n" +
	...
	"mcpContext\x1aT\n" +
	"\vTaskContext\x12/\n" +
	"\x05tasks\x18\x01 \x03(\v2\x19.warp.multi_agent.v1.TaskR\x05tasksJ\x04\b\x02\x10\x03R\x0eactive_task_id\x1a\xd66\n" +
	"\x05Input\x12;\n" +
	...
	"\n" +
	"read_skill\x18\x1a \x01(\v2$.warp.multi_agent.v1.ReadSkillResultH\x00R\treadSkill\x12K\n" +
	"\fask_question\x18\x1b \x01(\v2&.warp.multi_agent.v1.AskQuestionResultH\x00R\vaskQuestionB\b\n" +
	"\x06resultJ\x04\b\n" +
...
var file_request_proto_goTypes = []any{
	...
	(*AskQuestionResult)(nil),                       // 72: warp.multi_agent.v1.AskQuestionResult
...
var file_request_proto_depIdxs = []int32{
	...
	72, // 64: warp.multi_agent.v1.Request.Input.ToolCallResult.ask_question:type_name -> warp.multi_agent.v1.AskQuestionResult
...
func file_request_proto_init() {
	...
	file_request_proto_msgTypes[9].OneofWrappers = []any{
		...
		(*request_Input_ToolCallResult_AskQuestion)(nil),
	}
