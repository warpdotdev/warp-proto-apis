...
type Request_Metadata struct {
	...
	xxx_hidden_TeamUid                  *string                    `protobuf:"bytes,7,opt,name=team_uid,json=teamUid"`
...
func (x *Request_Metadata) GetTeamUid() string {
	if x != nil {
...
func (x *Request_Metadata) SetTeamUid(v string) {
...
func (x *Request_Metadata) HasTeamUid() bool {
	if x == nil {
		return false
	}
...
func (x *Request_Metadata) ClearTeamUid() {
...
type Request_Metadata_builder struct {
	...
	AgentName *string
	// Optional UID of the team the request should be attributed to (e.g. for
	// billing, credits, and team-scoped configuration).
	//
	// When set, the server verifies that the authenticated user is a member
	// of this team and rejects the request if not. When unset (e.g. older
	// clients), the server falls back to its default team resolution for the
	// user (historically, the first team returned for the user).
	TeamUid *string
}
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\x1a\x13orchestration.proto\"\xb2|\n" +
	"\aRequest\x12K\n" +
	...
	"\n" +
	"agent_name\x18\x06 \x01(\tB\x04\x80\xb5\x18\x01R\tagentName\x12\x19\n" +
	"\bteam_uid\x18\a \x01(\tR\ateamUid\x1aR\n" +
	"\fLoggingEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\xda\"\n" +
	"\bSettings\x12T\n" +
