...
type Request_Settings struct {
	...
	xxx_hidden_SupportsServerSynthesizedClientToolResults bool                                   `protobuf:"varint,34,opt,name=supports_server_synthesized_client_tool_results,json=supportsServerSynthesizedClientToolResults"`
	XXX_raceDetectHookData                                protoimpl.RaceDetectHookData
...
func (x *Request_Settings) GetSupportsServerSynthesizedClientToolResults() bool {
	if x != nil {
		return x.xxx_hidden_SupportsServerSynthesizedClientToolResults
	}
	return false
}
...
func (x *Request_Settings) SetSupportsServerSynthesizedClientToolResults(v bool) {
	x.xxx_hidden_SupportsServerSynthesizedClientToolResults = v
...
func (x *Request_Settings) HasSupportsServerSynthesizedClientToolResults() bool {
	if x == nil {
		return false
	}
...
func (x *Request_Settings) ClearSupportsServerSynthesizedClientToolResults() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[1]), 33)
	x.xxx_hidden_SupportsServerSynthesizedClientToolResults = false
}
...
type Request_Settings_builder struct {
	...
	// If `true`, the client consumes server-synthesized results paired with
	// client tool calls and suppresses local execution of the resolved calls.
	SupportsServerSynthesizedClientToolResults *bool
}
...
func (b0 Request_Settings_builder) Build() *Request_Settings {
	...
	if b.SupportsServerSynthesizedClientToolResults != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[1]), 33, 34)
		x.xxx_hidden_SupportsServerSynthesizedClientToolResults = *b.SupportsServerSynthesizedClientToolResults
	}
	return m0
}
...
const file_request_proto_rawDesc = "" +
	...
	"task.proto\x1a\vskill.proto\x1a\x13orchestration.proto\"\xac~\n" +
	"\aRequest\x12K\n" +
	...
	"\x05value\x18\x02 \x01(\v2\x16.google.protobuf.ValueR\x05value:\x028\x01\x1a\xef$\n" +
	"\bSettings\x12T\n" +
	...
	"\x1bsupports_stored_screenshots\x18! \x01(\bR\x19supportsStoredScreenshots\x12c\n" +
	"/supports_server_synthesized_client_tool_results\x18\" \x01(\bR*supportsServerSynthesizedClientToolResults\x1a\xea\x01\n" +
