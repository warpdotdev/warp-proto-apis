...
type OrchestrationConfig_Remote_builder struct {
	...
	WorkerHost    *string
	// Optional runner UID pre-declaring the compute config for children of this
	// plan. Inherited by matching `run_agents` calls; omitted preserves current
	// behavior (environment default then system defaults).
	RunnerId *string
}
