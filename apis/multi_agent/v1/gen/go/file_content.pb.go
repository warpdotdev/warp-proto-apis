...
func (x *FileContentLineRange) Reset() {
	*x = FileContentLineRange{}
	mi := &file_multi_agent_v1_file_content_proto_msgTypes[0]
...
func (x *FileContent) Reset() {
	*x = FileContent{}
	mi := &file_multi_agent_v1_file_content_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *BinaryFileContent) Reset() {
	*x = BinaryFileContent{}
	mi := &file_multi_agent_v1_file_content_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AnyFileContent) Reset() {
	*x = AnyFileContent{}
	mi := &file_multi_agent_v1_file_content_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x case_AnyFileContent_Content) String() string {
	md := file_multi_agent_v1_file_content_proto_msgTypes[3].Descriptor()
	if x == 0 {
		return "not set"
	}
...
var File_multi_agent_v1_file_content_proto protoreflect.FileDescriptor

const file_multi_agent_v1_file_content_proto_rawDesc = "" +
	"\n" +
	"!multi_agent/v1/file_content.proto\x12\x13warp.multi_agent.v1\x1a!google/protobuf/go_features.proto\x1a\x1cmulti_agent/v1/options.proto\">\n" +
...
var file_multi_agent_v1_file_content_proto_depIdxs = []int32{
...
func init() { file_multi_agent_v1_file_content_proto_init() }
func file_multi_agent_v1_file_content_proto_init() {
	if File_multi_agent_v1_file_content_proto != nil {
		return
	}
	file_multi_agent_v1_options_proto_init()
	file_multi_agent_v1_file_content_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_multi_agent_v1_file_content_proto_rawDesc), len(file_multi_agent_v1_file_content_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_multi_agent_v1_file_content_proto_goTypes,
		DependencyIndexes: file_multi_agent_v1_file_content_proto_depIdxs,
		MessageInfos:      file_multi_agent_v1_file_content_proto_msgTypes,
	}.Build()
	File_multi_agent_v1_file_content_proto = out.File
	file_multi_agent_v1_file_content_proto_goTypes = nil
	file_multi_agent_v1_file_content_proto_depIdxs = nil
}
