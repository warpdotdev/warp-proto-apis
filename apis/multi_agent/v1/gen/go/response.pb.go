...
type ResponseEvent_StreamFinished_ConversationUsageMetadata struct {
	...
	xxx_hidden_TotalProviderCostInCents *wrapperspb.FloatValue                                   `protobuf:"bytes,12,opt,name=total_provider_cost_in_cents,json=totalProviderCostInCents"`
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) GetTotalProviderCostInCents() *wrapperspb.FloatValue {
	if x != nil {
		return x.xxx_hidden_TotalProviderCostInCents
	}
	return nil
}
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) SetTotalProviderCostInCents(v *wrapperspb.FloatValue) {
	x.xxx_hidden_TotalProviderCostInCents = v
}
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) HasTotalProviderCostInCents() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_TotalProviderCostInCents != nil
}
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) ClearTotalProviderCostInCents() {
	x.xxx_hidden_TotalProviderCostInCents = nil
}
...
type ResponseEvent_StreamFinished_ConversationUsageMetadata_builder struct {
	...
	// The cumulative provider cost spent so far in the conversation, in cents
	// (fractional cents allowed). Uses FloatValue rather than a plain float so
	// absence survives both the Go and Rust code generators: absent means the
	// server cannot establish a complete historical baseline, which is
	// distinct from a known zero.
	TotalProviderCostInCents *wrapperspb.FloatValue
...
func (b0 ResponseEvent_StreamFinished_ConversationUsageMetadata_builder) Build() *ResponseEvent_StreamFinished_ConversationUsageMetadata {
	...
	x.xxx_hidden_TotalProviderCostInCents = b.TotalProviderCostInCents
...
const file_response_proto_rawDesc = "" +
	"\n" +
	"\x0eresponse.proto\x12\x13warp.multi_agent.v1\x1a google/protobuf/field_mask.proto\x1a!google/protobuf/go_features.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\roptions.proto\x1a\x11suggestions.proto\x1a\n" +
	"task.proto\"\x811\n" +
	"\rResponseEvent\x12C\n" +
	...
	"\rClientActions\x12;\n" +
	"\aactions\x18\x01 \x03(\v2!.warp.multi_agent.v1.ClientActionR\aactions\x1a\xbb-\n" +
	...
	"\x1bconversation_usage_metadata\x18\v \x01(\v2K.warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadataR\x19conversationUsageMetadata\x1a\x99\f\n" +
	...
	"\x16platform_credits_spent\x18\b \x01(\x02R\x14platformCreditsSpent\x12[\n" +
	"\x1ctotal_provider_cost_in_cents\x18\f \x01(\v2\x1b.google.protobuf.FloatValueR\x18totalProviderCostInCents\x12\xa8\x01\n" +
...
var file_response_proto_depIdxs = []int32{
	...
	41, // 32: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.total_provider_cost_in_cents:type_name -> google.protobuf.FloatValue
	...
	27, // 36: warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage.token_usage_by_category:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage.TokenUsageByCategoryEntry
	13, // 37: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.run_command_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.RunCommandStats
	11, // 38: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.read_files_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 39: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.search_codebase_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 40: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.grep_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 41: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.file_glob_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 42: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.apply_file_diff_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ApplyFileDiffStats
	11, // 43: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.write_to_long_running_shell_command_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 44: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.read_mcp_resource_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 45: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.call_mcp_tool_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 46: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.suggest_plan_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 47: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.suggest_create_plan_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 48: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.read_shell_command_output_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	11, // 49: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.use_computer_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	0,  // 50: warp.multi_agent.v1.ResponseEvent.StreamFinished.InvalidApiKey.provider:type_name -> warp.multi_agent.v1.LLMProvider
	9,  // 51: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.WarpTokenUsageEntry.value:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
	9,  // 52: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.ByokTokenUsageEntry.value:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
	9,  // 53: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.CustomEndpointTokenUsageEntry.value:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
