...
type ResponseEvent_StreamFinished struct {
	...
	xxx_hidden_PrunedMedia               *ResponseEvent_StreamFinished_PrunedMediaSummary        `protobuf:"bytes,13,opt,name=pruned_media,json=prunedMedia"`
	XXX_raceDetectHookData               protoimpl.RaceDetectHookData
	XXX_presence                         [1]uint32
	unknownFields                        protoimpl.UnknownFields
	sizeCache                            protoimpl.SizeCache
...
func (x *ResponseEvent_StreamFinished) GetPrunedMedia() *ResponseEvent_StreamFinished_PrunedMediaSummary {
	if x != nil {
		return x.xxx_hidden_PrunedMedia
	}
	return nil
}
...
func (x *ResponseEvent_StreamFinished) SetPrunedMedia(v *ResponseEvent_StreamFinished_PrunedMediaSummary) {
	x.xxx_hidden_PrunedMedia = v
}
...
func (x *ResponseEvent_StreamFinished) HasPrunedMedia() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_PrunedMedia != nil
}
...
func (x *ResponseEvent_StreamFinished) ClearPrunedMedia() {
	x.xxx_hidden_PrunedMedia = nil
}
...
type ResponseEvent_StreamFinished_builder struct {
	...
	// Reports media (image, video, etc.) attachments removed from this request to fit the
	// resolved model's real limits (see the server's model-aware media pruning). This is
	// per-request only, never part of persisted conversation state: the same history sent to a
	// different (e.g. larger-context) model on a later turn may not be pruned at all, so the
	// client must treat this as a transient, per-response signal rather than accumulate or
	// persist it onto the conversation.
	PrunedMedia *ResponseEvent_StreamFinished_PrunedMediaSummary
}
...
func (b0 ResponseEvent_StreamFinished_builder) Build() *ResponseEvent_StreamFinished {
	...
	x.xxx_hidden_PrunedMedia = b.PrunedMedia
	return m0
}
...
type ResponseEvent_StreamFinished_PrunedMediaSummary struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_PrunedCount uint32                 `protobuf:"varint,1,opt,name=pruned_count,json=prunedCount"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) Reset() {
	*x = ResponseEvent_StreamFinished_PrunedMediaSummary{}
	mi := &file_response_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResponseEvent_StreamFinished_PrunedMediaSummary) ProtoMessage() {}

func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) ProtoReflect() protoreflect.Message {
	mi := &file_response_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) GetPrunedCount() uint32 {
	if x != nil {
		return x.xxx_hidden_PrunedCount
	}
	return 0
}

func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) SetPrunedCount(v uint32) {
	x.xxx_hidden_PrunedCount = v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 1)
}

func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) HasPrunedCount() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *ResponseEvent_StreamFinished_PrunedMediaSummary) ClearPrunedCount() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_PrunedCount = 0
}

type ResponseEvent_StreamFinished_PrunedMediaSummary_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.

	// How many media items were removed from this request's attachments to fit the resolved
	// model's limits. Older turns are pruned before the current turn's own attachments, so a
	// non-zero count here most often means earlier images are no longer visible to the model.
	PrunedCount *uint32
}

func (b0 ResponseEvent_StreamFinished_PrunedMediaSummary_builder) Build() *ResponseEvent_StreamFinished_PrunedMediaSummary {
	m0 := &ResponseEvent_StreamFinished_PrunedMediaSummary{}
	b, x := &b0, m0
	_, _ = b, x
	if b.PrunedCount != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 1)
		x.xxx_hidden_PrunedCount = *b.PrunedCount
	}
	return m0
}
...
const file_response_proto_rawDesc = "" +
	...
	"\rClientActions\x12;\n" +
	"\aactions\x18\x01 \x03(\v2!.warp.multi_agent.v1.ClientActionR\aactions\x1a\x80.\n" +
	...
	"\x1bconversation_usage_metadata\x18\v \x01(\v2K.warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadataR\x19conversationUsageMetadata\x12g\n" +
	"\fpruned_media\x18\r \x01(\v2D.warp.multi_agent.v1.ResponseEvent.StreamFinished.PrunedMediaSummaryR\vprunedMedia\x1a7\n" +
	"\x12PrunedMediaSummary\x12!\n" +
	"\fpruned_count\x18\x01 \x01(\rR\vprunedCount\x1a\xbc\v\n" +
...
var file_response_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_response_proto_goTypes = []any{
	...
	(*ResponseEvent_StreamFinished_PrunedMediaSummary)(nil),        // 7: warp.multi_agent.v1.ResponseEvent.StreamFinished.PrunedMediaSummary
	...
	(*ClientAction_CreateTask)(nil), // 29: warp.multi_agent.v1.ClientAction.CreateTask
	(*ClientAction_UpdateTaskServerData)(nil),   // 30: warp.multi_agent.v1.ClientAction.UpdateTaskServerData
	(*ClientAction_UpdateTaskDescription)(nil),  // 31: warp.multi_agent.v1.ClientAction.UpdateTaskDescription
	(*ClientAction_AddMessagesToTask)(nil),      // 32: warp.multi_agent.v1.ClientAction.AddMessagesToTask
	(*ClientAction_UpdateTaskMessage)(nil),      // 33: warp.multi_agent.v1.ClientAction.UpdateTaskMessage
	(*ClientAction_AppendToMessageContent)(nil), // 34: warp.multi_agent.v1.ClientAction.AppendToMessageContent
	(*ClientAction_UpdateTaskSummary)(nil),      // 35: warp.multi_agent.v1.ClientAction.UpdateTaskSummary
	(*ClientAction_BeginTransaction)(nil),       // 36: warp.multi_agent.v1.ClientAction.BeginTransaction
	(*ClientAction_CommitTransaction)(nil),      // 37: warp.multi_agent.v1.ClientAction.CommitTransaction
	(*ClientAction_RollbackTransaction)(nil),    // 38: warp.multi_agent.v1.ClientAction.RollbackTransaction
	(*ClientAction_StartNewConversation)(nil),   // 39: warp.multi_agent.v1.ClientAction.StartNewConversation
	(*ClientAction_MoveMessagesToNewTask)(nil),  // 40: warp.multi_agent.v1.ClientAction.MoveMessagesToNewTask
...
var file_response_proto_depIdxs = []int32{
	...
	29, // 3: warp.multi_agent.v1.ClientAction.create_task:type_name -> warp.multi_agent.v1.ClientAction.CreateTask
	32, // 4: warp.multi_agent.v1.ClientAction.add_messages_to_task:type_name -> warp.multi_agent.v1.ClientAction.AddMessagesToTask
	33, // 5: warp.multi_agent.v1.ClientAction.update_task_message:type_name -> warp.multi_agent.v1.ClientAction.UpdateTaskMessage
	34, // 6: warp.multi_agent.v1.ClientAction.append_to_message_content:type_name -> warp.multi_agent.v1.ClientAction.AppendToMessageContent
	41, // 7: warp.multi_agent.v1.ClientAction.show_suggestions:type_name -> warp.multi_agent.v1.Suggestions
	35, // 8: warp.multi_agent.v1.ClientAction.update_task_summary:type_name -> warp.multi_agent.v1.ClientAction.UpdateTaskSummary
	31, // 9: warp.multi_agent.v1.ClientAction.update_task_description:type_name -> warp.multi_agent.v1.ClientAction.UpdateTaskDescription
	36, // 10: warp.multi_agent.v1.ClientAction.begin_transaction:type_name -> warp.multi_agent.v1.ClientAction.BeginTransaction
	37, // 11: warp.multi_agent.v1.ClientAction.commit_transaction:type_name -> warp.multi_agent.v1.ClientAction.CommitTransaction
	38, // 12: warp.multi_agent.v1.ClientAction.rollback_transaction:type_name -> warp.multi_agent.v1.ClientAction.RollbackTransaction
	39, // 13: warp.multi_agent.v1.ClientAction.start_new_conversation:type_name -> warp.multi_agent.v1.ClientAction.StartNewConversation
	30, // 14: warp.multi_agent.v1.ClientAction.update_task_server_data:type_name -> warp.multi_agent.v1.ClientAction.UpdateTaskServerData
	40, // 15: warp.multi_agent.v1.ClientAction.move_messages_to_new_task:type_name -> warp.multi_agent.v1.ClientAction.MoveMessagesToNewTask
	...
	16, // 25: warp.multi_agent.v1.ResponseEvent.StreamFinished.token_usage:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.TokenUsage
	15, // 26: warp.multi_agent.v1.ResponseEvent.StreamFinished.request_cost:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.RequestCost
	...
	7,  // 28: warp.multi_agent.v1.ResponseEvent.StreamFinished.pruned_media:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.PrunedMediaSummary
	10, // 29: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.token_usage:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
	11, // 30: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.tool_usage_metadata:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata
	25, // 31: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.warp_token_usage:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.WarpTokenUsageEntry
	26, // 32: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.byok_token_usage:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.ByokTokenUsageEntry
	27, // 33: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.custom_endpoint_token_usage:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.CustomEndpointTokenUsageEntry
	9,  // 34: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.context_window_segments:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ContextWindowSegment
	1,  // 35: warp.multi_agent.v1.ResponseEvent.StreamFinished.ContextWindowSegment.segment_type:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ContextWindowSegmentType
	28, // 36: warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage.token_usage_by_category:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage.TokenUsageByCategoryEntry
	14, // 37: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.run_command_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.RunCommandStats
	12, // 38: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.read_files_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 39: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.search_codebase_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 40: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.grep_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 41: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.file_glob_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	13, // 42: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.apply_file_diff_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ApplyFileDiffStats
	12, // 43: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.write_to_long_running_shell_command_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 44: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.read_mcp_resource_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 45: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.call_mcp_tool_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 46: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.suggest_plan_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 47: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.suggest_create_plan_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 48: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.read_shell_command_output_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	12, // 49: warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolUsageMetadata.use_computer_stats:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ToolCallStats
	0,  // 50: warp.multi_agent.v1.ResponseEvent.StreamFinished.InvalidApiKey.provider:type_name -> warp.multi_agent.v1.LLMProvider
	10, // 51: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.WarpTokenUsageEntry.value:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
	10, // 52: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.ByokTokenUsageEntry.value:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
	10, // 53: warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadata.CustomEndpointTokenUsageEntry.value:type_name -> warp.multi_agent.v1.ResponseEvent.StreamFinished.ModelTokenUsage
	42, // 54: warp.multi_agent.v1.ClientAction.CreateTask.task:type_name -> warp.multi_agent.v1.Task
	43, // 55: warp.multi_agent.v1.ClientAction.AddMessagesToTask.messages:type_name -> warp.multi_agent.v1.Message
	43, // 56: warp.multi_agent.v1.ClientAction.UpdateTaskMessage.message:type_name -> warp.multi_agent.v1.Message
	44, // 57: warp.multi_agent.v1.ClientAction.UpdateTaskMessage.mask:type_name -> google.protobuf.FieldMask
	43, // 58: warp.multi_agent.v1.ClientAction.AppendToMessageContent.message:type_name -> warp.multi_agent.v1.Message
	44, // 59: warp.multi_agent.v1.ClientAction.AppendToMessageContent.mask:type_name -> google.protobuf.FieldMask
	42, // 60: warp.multi_agent.v1.ClientAction.MoveMessagesToNewTask.new_task:type_name -> warp.multi_agent.v1.Task
	43, // 61: warp.multi_agent.v1.ClientAction.MoveMessagesToNewTask.replacement_messages:type_name -> warp.multi_agent.v1.Message
