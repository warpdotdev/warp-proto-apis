...
type ResponseEvent_StreamFinished_ConversationUsageMetadata struct {
	...
	xxx_hidden_TotalProviderCostInCents float32                                                  `protobuf:"fixed32,12,opt,name=total_provider_cost_in_cents,json=totalProviderCostInCents"`
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) GetTotalProviderCostInCents() float32 {
	if x != nil {
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) SetTotalProviderCostInCents(v float32) {
...
func (x *ResponseEvent_StreamFinished_ConversationUsageMetadata) ClearTotalProviderCostInCents() {
	...
	x.xxx_hidden_TotalProviderCostInCents = 0
}
...
type ResponseEvent_StreamFinished_ConversationUsageMetadata_builder struct {
	...
	// The cumulative provider-dollar cost spent so far, in cents.
	// Absent when the server cannot establish a complete historical baseline.
	TotalProviderCostInCents *float32
...
func (b0 ResponseEvent_StreamFinished_ConversationUsageMetadata_builder) Build() *ResponseEvent_StreamFinished_ConversationUsageMetadata {
	...
	if b.TotalProviderCostInCents != nil {
...
const file_response_proto_rawDesc = "" +
	...
	"\rClientActions\x12;\n" +
	"\aactions\x18\x01 \x03(\v2!.warp.multi_agent.v1.ClientActionR\aactions\x1a\x9e-\n" +
	...
	"\x1bconversation_usage_metadata\x18\v \x01(\v2K.warp.multi_agent.v1.ResponseEvent.StreamFinished.ConversationUsageMetadataR\x19conversationUsageMetadata\x1a\xfc\v\n" +
	...
	"\x1ctotal_provider_cost_in_cents\x18\f \x01(\x02R\x18totalProviderCostInCents\x12\xa8\x01\n" +
