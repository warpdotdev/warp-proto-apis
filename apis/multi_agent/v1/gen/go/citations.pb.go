...
func (DocumentType) Descriptor() protoreflect.EnumDescriptor {
	return file_multi_agent_v1_citations_proto_enumTypes[0].Descriptor()
}

func (DocumentType) Type() protoreflect.EnumType {
	return &file_multi_agent_v1_citations_proto_enumTypes[0]
}
...
func (x *Citation) Reset() {
	*x = Citation{}
	mi := &file_multi_agent_v1_citations_proto_msgTypes[0]
...
var File_multi_agent_v1_citations_proto protoreflect.FileDescriptor

const file_multi_agent_v1_citations_proto_rawDesc = "" +
	"\n" +
	"\x1emulti_agent/v1/citations.proto\x12\x13warp.multi_agent.v1\x1a!google/protobuf/go_features.proto\"s\n" +
	"\bCitation\x12\x1f\n" +
...
var file_multi_agent_v1_citations_proto_goTypes = []any{
	(DocumentType)(0), // 0: warp.multi_agent.v1.DocumentType
	(*Citation)(nil),  // 1: warp.multi_agent.v1.Citation
}
var file_multi_agent_v1_citations_proto_depIdxs = []int32{
...
func init() { file_multi_agent_v1_citations_proto_init() }
func file_multi_agent_v1_citations_proto_init() {
	if File_multi_agent_v1_citations_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_multi_agent_v1_citations_proto_rawDesc), len(file_multi_agent_v1_citations_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_multi_agent_v1_citations_proto_goTypes,
		DependencyIndexes: file_multi_agent_v1_citations_proto_depIdxs,
		EnumInfos:         file_multi_agent_v1_citations_proto_enumTypes,
		MessageInfos:      file_multi_agent_v1_citations_proto_msgTypes,
	}.Build()
	File_multi_agent_v1_citations_proto = out.File
	file_multi_agent_v1_citations_proto_goTypes = nil
	file_multi_agent_v1_citations_proto_depIdxs = nil
}
