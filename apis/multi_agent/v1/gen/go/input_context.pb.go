...
type InputContext struct {
	...
	xxx_hidden_Videos                   *[]*InputContext_Video          `protobuf:"bytes,14,rep,name=videos"`
...
func (x *InputContext) GetVideos() []*InputContext_Video {
	if x != nil {
		if x.xxx_hidden_Videos != nil {
			return *x.xxx_hidden_Videos
		}
	}
	return nil
}
...
func (x *InputContext) SetVideos(v []*InputContext_Video) {
	x.xxx_hidden_Videos = &v
}
...
type InputContext_builder struct {
	...
	// Any attached videos. Sent alongside their extracted-frame fallback representation so the
	// server can pick whichever one suits the resolved model: a native video part for providers
	// that support it (currently Gemini 2.5/3.x), or the frames for everyone else. A single video
	// is never split across both representations for the same request.
	Videos []*InputContext_Video
}
...
// A video attachment. `data` is populated when the video was small enough to send inline
// (client-enforced cap); `frames` is always populated as a client-side-extracted fallback,
...
func (x *InputContext_Video) Reset() {
	*x = InputContext_Video{}
	mi := &file_input_context_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InputContext_Video) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InputContext_Video) ProtoMessage() {}

func (x *InputContext_Video) ProtoReflect() protoreflect.Message {
	mi := &file_input_context_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *InputContext_Video) GetData() []byte {
	if x != nil {
		return x.xxx_hidden_Data
	}
	return nil
...
func (x *InputContext_Video) GetMimeType() string {
	if x != nil {
		if x.xxx_hidden_MimeType != nil {
			return *x.xxx_hidden_MimeType
		}
...
func (x *InputContext_Video) GetFrames() []*InputContext_Image {
	if x != nil {
...
func (x *InputContext_Video) HasMimeType() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
type InputContext_Video_builder struct {
	...
	// Raw video payload. Absent (empty) when the source video exceeded the client's size cap.
	//
	// TODO: like Image.data above, the client should NOT base64 encode this. It should send raw
	// binary data and the server should base64-encode it before sending to the LLM, if needed.
	Data []byte
...
func (x *InputContext_Git_PullRequest) Reset() {
	*x = InputContext_Git_PullRequest{}
	mi := &file_input_context_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_input_context_proto_rawDesc = "" +
	...
	"\x05files\x18\t \x03(\v2&.warp.multi_agent.v1.InputContext.FileR\x05files\x12?\n" +
	"\x06videos\x18\x0e \x03(\v2'.warp.multi_agent.v1.InputContext.VideoR\x06videos\x1a(\n" +
...
var file_input_context_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_input_context_proto_goTypes = []any{
	...
	(*InputContext_Video)(nil),              // 9: warp.multi_agent.v1.InputContext.Video
	(*InputContext_ProjectRules)(nil),       // 10: warp.multi_agent.v1.InputContext.ProjectRules
	(*InputContext_Git)(nil),                // 11: warp.multi_agent.v1.InputContext.Git
	(*InputContext_SkillsContext)(nil),      // 12: warp.multi_agent.v1.InputContext.SkillsContext
	(*InputContext_LspServersContext)(nil),  // 13: warp.multi_agent.v1.InputContext.LspServersContext
	(*InputContext_Git_Repository)(nil),     // 14: warp.multi_agent.v1.InputContext.Git.Repository
	(*InputContext_Git_PullRequest)(nil),    // 15: warp.multi_agent.v1.InputContext.Git.PullRequest
	(*timestamppb.Timestamp)(nil),           // 16: google.protobuf.Timestamp
	(*ExecutedShellCommand)(nil),            // 17: warp.multi_agent.v1.ExecutedShellCommand
	(*FileContent)(nil),                     // 18: warp.multi_agent.v1.FileContent
	(*SkillDescriptor)(nil),                 // 19: warp.multi_agent.v1.SkillDescriptor
	(*LspDescriptor)(nil),                   // 20: warp.multi_agent.v1.LspDescriptor
}
var file_input_context_proto_depIdxs = []int32{
	...
	16, // 3: warp.multi_agent.v1.InputContext.current_time:type_name -> google.protobuf.Timestamp
	...
	11, // 6: warp.multi_agent.v1.InputContext.git:type_name -> warp.multi_agent.v1.InputContext.Git
	12, // 7: warp.multi_agent.v1.InputContext.updated_skills_context:type_name -> warp.multi_agent.v1.InputContext.SkillsContext
	13, // 8: warp.multi_agent.v1.InputContext.updated_lsp_servers_context:type_name -> warp.multi_agent.v1.InputContext.LspServersContext
	17, // 9: warp.multi_agent.v1.InputContext.executed_shell_commands:type_name -> warp.multi_agent.v1.ExecutedShellCommand
	...
	9,  // 13: warp.multi_agent.v1.InputContext.videos:type_name -> warp.multi_agent.v1.InputContext.Video
	18, // 14: warp.multi_agent.v1.InputContext.File.content:type_name -> warp.multi_agent.v1.FileContent
	6,  // 15: warp.multi_agent.v1.InputContext.Video.frames:type_name -> warp.multi_agent.v1.InputContext.Image
	18, // 16: warp.multi_agent.v1.InputContext.ProjectRules.active_rule_files:type_name -> warp.multi_agent.v1.FileContent
	14, // 17: warp.multi_agent.v1.InputContext.Git.repository:type_name -> warp.multi_agent.v1.InputContext.Git.Repository
	15, // 18: warp.multi_agent.v1.InputContext.Git.pull_request:type_name -> warp.multi_agent.v1.InputContext.Git.PullRequest
	19, // 19: warp.multi_agent.v1.InputContext.SkillsContext.available_skills:type_name -> warp.multi_agent.v1.SkillDescriptor
	20, // 20: warp.multi_agent.v1.InputContext.LspServersContext.available_lsp_servers:type_name -> warp.multi_agent.v1.LspDescriptor
	0,  // 21: warp.multi_agent.v1.InputContext.Git.PullRequest.state:type_name -> warp.multi_agent.v1.InputContext.Git.PullRequest.State
